...
def list_glossary_records_controller(
    db: Session, glossary_id: int, page: int, page_records: int, search: str | None = None
):
    records = GlossaryQuery(db).list_glossary_records(glossary_id, page, page_records, search)
